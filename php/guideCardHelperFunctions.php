...
/*
 * echo a html structure that shows all guide cards for a specific character by a foreach loop and calling showGuideCard function
 * $db -> the instance of database
 * $guides -> an array of guide data from database
 */
function showGuideCards($db, $guides){
    foreach ($guides as $data) {
        ...
        showGuideCard($db, $data, $bestWeapon, $replacementWeapon, $artifact_1, $artifact_2, $publisher, $formattedDate);
    }
}

/*
 * echo a html structure that shows a single guide card
 * $db -> the instance of database
 * data -> guide data from database
 * $bestWeapon -> a weapon data from database
 * $replacementWeapon -> a weapon data from database
 * artifact_1 -> an artifact data from database
 * artifact_2 -> an artifact data from database
 * $publisher -> a user data from database
 * $formattedDate -> a time from the guide data
 */
function showGuideCard($db, $data, $bestWeapon, $replacementWeapon, $artifact_1, $artifact_2, $publisher, $formattedDate){
