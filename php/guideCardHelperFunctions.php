...
function showGuideCard($db, $guides){
    foreach ($guides as $data) {
        $bestWeapon = queryByPrimaryKeyForGuide($db,"weapons",$data['bestWeaponID'], "id");
        $replacementWeapon = queryByPrimaryKeyForGuide($db,"weapons",$data['replacementWeaponID'], "id");
        $artifact_1 = queryByPrimaryKeyForGuide($db,"artifacts",$data['artifactID_1'], "id");
        $artifact_2 = queryByPrimaryKeyForGuide($db,"artifacts",$data['artifactID_2'], "id");
...
function queryByPrimaryKeyForGuide($db, $table, $id, $key){
    if (!is_numeric($id)) {
        echo "Invalid ID";
        return null;
    }
...
function sortingGuideDataByTime($db, $order, $id, $time, $key, $table){
